...
TEST(SelectionSortTests, TestArrayOfIntegers) {
...
TEST(SelectionSortTests, TestRandomArrayOfIntegers) {
  srand(time(NULL));
...
TEST(SelectionSortTests, TestArrayOfStrings) {
  ...
  SelectionSort<std::string>::Sort(elements);
...
TEST(SelectionSortTests, TestArrayOfDoubles) {
  ...
  SelectionSort<double>::Sort(elements);
...
TEST(SelectionSortTests, TestArrayOfIntegersInDecendingOrder) {
  std::vector<int> elements{ 5,3,7,8,0,4,2 };
  auto elements_copy{ elements };
  ...
  SelectionSort<int>::Sort(elements, [](int a, int b) {return a > b; });
